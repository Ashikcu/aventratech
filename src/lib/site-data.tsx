...
export const services = [
  {
    ...
    short: "Secure networking, cloud infrastructure, IT project management, and 24/7 services for healthcare, education, and corporate sectors, alongside dedicated personalized support.",
    details: [
      "Computer setup & configuration",
      "Network design & Wi-Fi deployment",
      "Server installation & maintenance",
      "IT support for students pursuing higher education abroad.",
